...
def get_mean_prediction(target_subject, source_subjects, voxels_dict={}):
    ...
    for source_subject in source_subjects:
        loaded = np.load('movie10_predictions_results/noise_ceiling/predict_{}_with_{}_{}pcs.npy'.format(target_subject, source_subject, voxels_dict[source_subject]) ,allow_pickle=True)
...
subs = ['1', '2','3', '4','5', '6']
n_voxels = [81924, 81924, 81924, 81924, 81924, 81924]
n_voxels_dict = {}
...
if __name__ == "__main__":
    ...
    np.save('movie10_predictions_results/noise_ceiling/subject_{}_kernel_ridge.npy'.format(target_subject),np.array(ceilings))
