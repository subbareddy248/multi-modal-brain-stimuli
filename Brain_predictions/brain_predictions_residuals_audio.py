...
if __name__ == "__main__":
    ...
    train_data = np.load('metajoint-videomae-train.npy', allow_pickle=True)
    test_data = np.load('metajoint-videomae-test.npy', allow_pickle=True)

    # train_data = np.load('tvlt-joint-ast-train.npy', allow_pickle=True)
    # test_data = np.load('tvlt-joint-ast-test.npy', allow_pickle=True)
